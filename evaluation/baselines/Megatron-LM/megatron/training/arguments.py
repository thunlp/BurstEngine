...
def _add_burst_args(parser):
    group = parser.add_argument_group(title='burst')
    group.add_argument('--use-burst', action='store_true',
                       help='use BurstAttention implementation of attention. '
                       'https://arxiv.org/abs/2403.09347')
    group.add_argument('--use-ulysses', action='store_true',
                       help='use BurstAttention implementation of attention. '
                       'https://arxiv.org/abs/2403.09347')
    group.add_argument('--causal', action='store_true',
                       help='Casual Attention mask')
    group.add_argument('--causal-tflops', action='store_true',
                       help='compute tflops considering causal attention')
    group.add_argument('--create-dq-comm', action='store_true',
                       help='create a new communicator for dq\'s communication in burst\'backward pass.')
    group.add_argument('--double-ring', action='store_true',
                       help='use double ring comm for BurstAttention')
    return parser
...
def _add_distributed_args(parser):
    ...
    group.add_argument('--method',
                       type=str, default=None,
                       help='method for distributed training')
