...
def training_log(loss_dict, total_loss_dict, learning_rate, iteration,
    ...
    if iteration % args.log_interval == 0:
        ...
        # elapsed_time = timers('forward-backward')._elapsed
        ...
        log_string += ' Max Mem: {:.2f} GB | Max Reserved: {:.2f} GB |'.format(torch.cuda.max_memory_allocated() / 1e9, torch.cuda.max_memory_reserved() / 1e9)
        total_loss_dict[advanced_iters_key] = 0
        ...
        # timer_log = timers.log(timers_to_log, normalizer=args.log_interval)
        # print_rank_last('timer-log')
        # print_rank_last(timer_log)
