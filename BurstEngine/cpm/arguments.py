...
def add_training_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument("--tokenizer-path", type=str, default=None, help="tokenizer_path")
    ...
    group.add_argument("--sp", default="none", type=str)
    group.add_argument("--ablation", default="", type=str)
    group.add_argument("--fused-sl-loss", action="store_true", help="whether we use fused sl loss")
    group.add_argument("--ffn-first", action="store_true", help="whether we use attn first")
    group.add_argument("--mask", action="store_true", help="whether we use mask")
    group.add_argument("--tp", default=1, type=int)
    group.add_argument("--tp-sp", action="store_true", help="tp sp")
    group.add_argument("--eval_only", action="store_true", help="to eval only")
    group.add_argument("--spzero", action="store_true", help="to sp+zero")
    group.add_argument("--ckpt", action="store_true", help="use ckpt")
    group.add_argument("--ppl", action="store_true", help="to get PPL")
